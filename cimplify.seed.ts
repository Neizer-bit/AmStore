 ...
 *
 * Tags drive the card badges (New / Bestseller / Limited / Handmade); "Sale"
 * is kept alongside them for the sale collection.
 */
...
export default defineSeed((ctx) => {
  ...
  ctx.product({
    ...
    image: shot(2), tags: ["Bestseller", "Sale"],
  });
  ctx.product({
    ...
    image: shot(3), tags: ["Bestseller", "Sale"],
  });
  ctx.product({
    ...
    image: shot(4), tags: ["Limited", "Sale"],
  });
  ctx.product({
  ...
  ctx.product({
    ...
    image: shot(6), tags: ["Handmade", "Sale"],
  });
  ctx.product({
    ...
    image: shot(7), tags: ["Bestseller", "Sale"],
  });
  ctx.product({
    ...
    image: shot(8), tags: ["Handmade", "Sale"],
  });
  ctx.product({
  ...
  ctx.product({
    ...
    image: shot(10), tags: ["Limited", "Sale"],
  });
  ctx.product({
    ...
    image: shot(11), tags: ["Handmade", "Sale"],
  });
